import { Image, type ImageSourcePropType, SafeAreaView, View } from "react-native";
    ...
    <SafeAreaView style={{ paddingTop: insets.top }}>  
      <View className="flex justify-start bg-primary">
        ...
        <Link className="w-full h-full max-w-[80px] max-h-20" href='/doctor'>
          <Image className="w-full h-full max-w-[80px] max-h-20" source={beloHeaderLogo as ImageSourcePropType} />
        </Link>
